...
const PhoneModal = ({ value }) => {
  return (
    <div className="w-[30rem] h-[15rem] bg-white/10 backdrop-blur-xl flex flex-col rounded-md relative p-[0.5rem] shadow-md">
      <div className=" h-[50%] w-full center text-[2rem] leading-[2rem] pr-[2rem]">
        <span className=" after:absolute after:animate-dots dark:text-white">
          {value ? value + ' calling' : 'Someone calling'}
        </span>
      </div>
